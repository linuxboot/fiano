...
// To reproduce: go run github.com/linuxboot/fiano/pkg/intel/metadata/manifest/common/manifestcodegen/cmd/manifestcodegen github.com/linuxboot/fiano/pkg/intel/metadata/manifest/key
