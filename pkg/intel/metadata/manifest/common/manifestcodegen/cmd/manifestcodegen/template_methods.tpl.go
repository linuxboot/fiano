...
const templateMethods = `//go:build !manifestcodegen
// +build !manifestcodegen

// Code generated by "menifestcodegen". DO NOT EDIT.
// To reproduce: go run github.com/linuxboot/fiano/pkg/intel/metadata/manifest/common/manifestcodegen/cmd/manifestcodegen {{ .Package.Path }}
...
{{- if not .EnableTracing }}
	"encoding/binary"
{{- else }}
	binary "github.com/linuxboot/fiano/pkg/intel/metadata/manifest/common/tracedbinary"
{{- end }}
	"fmt"
	"io"
	"strings"
